...
def problem2a_testing():
    ...
    ############################################################################
    #  2: DONE Implement this TEST function.  See the IMPORTANT NOTE below.
    ...
    print('Test 1:')
    expected = 12
    actual = sum_of_digits_of_sum_of_factors(47)
    print()
    print('Expected:', expected)
    print('Actual:', actual)
    print()
    ...
    print('Test 4:')
    expected = 1
    actual = sum_of_digits_of_sum_of_factors(1)
    print()
    print('Expected', expected)
    print('Actual', actual)
    print()
...
################################################################################
# 3: DONE  READ the green doc-string for the   number_of_factors   function
